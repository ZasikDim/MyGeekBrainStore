...
protocol AuthRequestFactory {
    ...
    func register(username: String, password: String, email: String, gender: User.Gender, creditCard: String, bio: String,bcompletionHandler: @escaping (AFDataResponse<RegisterationResult>) -> Void)
